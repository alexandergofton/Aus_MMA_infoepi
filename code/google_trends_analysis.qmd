...
# files_dir Directory where Google Trends data files are stored
# search_terms Vector of search terms to include in the analysis
# output_dir Directory where to save the output plot (default: "figures")
...
combine_daily_data <- function(date_str, save_plot = TRUE) {
  ...
  for (term in search_terms) {
    ...
    if (file.exists(file_path)) {
      ...
      trend_data[[date_str]][[term]] <- read_csv(
        file_path,
  ...
  # Rename columns
  combined_data <- combined_data |> rename(!!!rename_mapping)
